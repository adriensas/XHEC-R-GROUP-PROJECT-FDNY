...
input_df <- data.frame(
  INCIDENT_DATE_TIME = as.POSIXct(map_dbl(1:10, function(x) 1543425183+x*900), origin='1970-01-01'),
  TEST = c(1,4,3,5,8,0,3,19,2,2)
)

expected_df <- data.frame(
  INCIDENT_DATE_TIME = as.POSIXct(map_dbl(1:6, function(x) 1543428000+x*1800), origin='1970-01-01'),
