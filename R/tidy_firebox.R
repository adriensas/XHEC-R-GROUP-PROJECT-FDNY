...
#Tidying the data and adding the same Borough column as in the original dataset
...
#Ploting the data
plot(nyc_map_firebox_full %>% select(Borough))

#Saving the new dataset
write.csv(nyc_map_firebox_full, "data/nyc_firebox.csv")